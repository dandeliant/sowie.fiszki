...
('tiger1', 'usta, buzia', 'Otwieram usta.', 'I open my mouth.'),
...
('tiger1', '(Banany) są z (roślin).', 'Banany pochodzą z roślin.', 'Bananas come from plants.'),
('tiger1', '(Szynka) to (mięso).', 'Szynka to mięso.', 'Ham is meat.'),
('tiger1', '(Szynka) jest od (zwierząt).', 'Szynka pochodzi od zwierząt.', 'Ham comes from animals.'),
